...
type ScannerInfo struct {
	...
	Domain         string   // web | network
	Subtype        string   // Vulnerability family
	SubtypeOptions []string // Customizable behavior profiles for this scanner
}
	...
	return []ScannerInfo{
		{
			...
			Domain:         "web",
			Subtype:        "Injection",
			SubtypeOptions: []string{"reflected", "stored", "dom", "full"},
		},
		{
			Type:           ScannerCSRF,
			...
			Severity:       "Medium",
			Domain:         "web",
			Subtype:        "Session/Auth",
			SubtypeOptions: []string{"post_forms", "state_change", "strict_token"},
		},
		{
			Type:           ScannerSQL,
			Name:           "SQL Injection",
			...
			Domain:         "web",
			Subtype:        "Injection",
			SubtypeOptions: []string{"error_based", "union_based", "time_based", "stacked"},
		},
		{
			Type:           ScannerLFI,
			...
			Domain:         "web",
			Subtype:        "File Access",
			SubtypeOptions: []string{"path_traversal", "wrapper_abuse", "sensitive_reads"},
		},
		{
			Type:           ScannerSSRF,
			...
			Severity:       "High",
			Domain:         "web",
			Subtype:        "Network Pivot",
			SubtypeOptions: []string{"metadata", "localhost", "internal_services"},
		},
		{
			...
			Domain:         "web",
			Subtype:        "Injection",
			SubtypeOptions: []string{"shell_metachar", "blind_timing", "oob_dns"},
		},
		{
			Type:           ScannerRCE,
			...
			SubtypeOptions: []string{"template_injection", "deserialization", "runtime_eval"},
		},
		{
			...
			Domain:         "web",
			Subtype:        "File Access",
			SubtypeOptions: []string{"dotdot_slash", "encoded_bypass", "windows_paths"},
		},
		{
			Type:           ScannerXXE,
			...
			Severity:       "High",
			Domain:         "web",
			Subtype:        "Parser Abuse",
			SubtypeOptions: []string{"file_disclosure", "ssrf_entities", "billion_laughs"},
		},
		{
			...
			Severity:       "Medium",
			Domain:         "web",
			Subtype:        "Navigation Flow",
			SubtypeOptions: []string{"query_redirect", "path_redirect", "double_encoding"},
		},
		{
			Type:           ScannerHeaders,
			...
			SubtypeOptions: []string{"browser_policy", "transport_policy", "legacy_headers"},
		},
		{
			Type:           ScannerFiles,
			...
			Severity:       "High",
			Domain:         "web",
			Subtype:        "Information Exposure",
			SubtypeOptions: []string{"backup_files", "config_leaks", "admin_artifacts"},
		},
		{
			Type:           ScannerNetwork,
			...
			Severity:       "High",
			Domain:         "network",
			Subtype:        "Port/Service Discovery",
			SubtypeOptions: []string{"surface"},
		},
	}
}
